...
#are deserts increased in loop2 (if you exclude cen regions``)
################################################################################################
...
Cen10 <- rtracklayer::import.bed('Cen20KbFlankRegions.bed')
axis_desert <- axis_desert[axis_desert %outside% Cen10,]
axis_cluster <- axis_cluster[axis_cluster %outside% Cen10,]
...
bedgraphs <- c("/Users/darmokandjalad/Documents/Hop1PHD-Loop2/RAnalysis/11644-NHantiHop1-20220331-20220125-20221004-Reps-SK1Yue-PM-PE_B4_W3_MACS2_FE.bdg.gz",
               "/Users/darmokandjalad/Documents/Hop1PHD-Loop2/RAnalysis/Hop1-wildtype-334-340-32-177-Reps-SK1Yue-PM_B3W3_MACS2_FE.bdg.gz",
               "/Users/darmokandjalad/Documents/Hop1PHD-Loop2/RAnalysis/Hop1_loop2_Reps_Norm.bed")
bedgraphs <- c( "Hop1_loop2_Reps_Norm.bed"
                )
...
for (i in 1:length(bedgraphs)) {
  ...
  pdf(paste0(name[1],"sigOn_axisSites_BootMetaPlot-outsideCen20.pdf"), height = 5, width = 5)
